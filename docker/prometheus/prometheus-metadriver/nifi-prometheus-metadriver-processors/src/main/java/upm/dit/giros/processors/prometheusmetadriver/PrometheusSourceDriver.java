...
/**
 * Prometheus YANGTools Source Driver.
 */
public class PrometheusSourceDriver {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(PrometheusSourceDriver.class);
    ...
    public PrometheusSourceDriver(){
        schemaContext = BindingRuntimeHelpers.createEffectiveModel(BindingReflections.loadModuleInfos(Metrics.class.getClassLoader()));
        codec = new BindingCodecContext(BindingRuntimeHelpers.createRuntimeContext(Metrics.class));
    ...
    public String driver(JsonArray data) {
