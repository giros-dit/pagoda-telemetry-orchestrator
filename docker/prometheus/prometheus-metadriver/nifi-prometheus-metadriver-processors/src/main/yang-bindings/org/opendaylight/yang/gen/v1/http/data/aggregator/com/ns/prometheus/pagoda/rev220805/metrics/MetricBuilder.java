...
public class MetricBuilder implements Builder<Metric> {
    ...
    public MetricBuilder(org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.prometheus.pagoda.rev220805.LabelSet arg) {
        this._labels = arg.getLabels();
    }
    
    public MetricBuilder(org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.prometheus.pagoda.rev220805.MetricPointSet arg) {
     ...
     * <ul>
     * <li>org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.prometheus.pagoda.rev220805.MetricPointSet</li>
     * <li>org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.prometheus.pagoda.rev220805.LabelSet</li>
     * </ul>
     *
    ...
    */
    public void fieldsFrom(DataObject arg) {
        ...
        if (arg instanceof org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.prometheus.pagoda.rev220805.MetricPointSet) {
            this._metricPoints = ((org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.prometheus.pagoda.rev220805.MetricPointSet)arg).getMetricPoints();
            isValidArg = true;
        }
        if (arg instanceof org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.prometheus.pagoda.rev220805.LabelSet) {
            this._labels = ((org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.prometheus.pagoda.rev220805.LabelSet)arg).getLabels();
            isValidArg = true;
        }
        CodeHelpers.validValue(isValidArg, arg, "[org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.prometheus.pagoda.rev220805.MetricPointSet, org.opendaylight.yang.gen.v1.http.data.aggregator.com.ns.prometheus.pagoda.rev220805.LabelSet]");
    }
